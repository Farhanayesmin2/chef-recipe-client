...
<footer aria-label="Site Footer" class="bg-white font-mono">
  <div class="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        <div class="flex justify-center h-8  items-center text-[#774d62] sm:justify-start">
                                <IoFastFoodSharp className=' font-bold'/>
                                <p1 className='text-xl font-extrabold font-mono'>Food Cuisine</p1>
        </div>
        ...
        <ul class="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
          <li>
            <a
              ...
              rel="noreferrer"
              target="_blank"
              class="text-blue-500 transition hover:text-teal-700/75"
            >
          ...
          <li>
            <a
              ...
              rel="noreferrer"
              target="_blank"
              class="text-red-900 transition hover:text-teal-700/75"
            >
          ...
          <li>
            <a
              ...
              rel="noreferrer"
              target="_blank"
              class="text-sky-600 transition hover:text-teal-700/75"
            >
          ...
          <li>
            <a
              ...
              rel="noreferrer"
              target="_blank"
              class="text-gray-700 transition hover:text-teal-700/75"
            >
          ...
          <li>
            <a
              ...
              rel="noreferrer"
              target="_blank"
              class="text-yellow-700 transition hover:text-teal-700/75"
            >
          ...
          <nav aria-label="Footer Helpful Nav" class="mt-8">
            <ul class="space-y-4 text-sm">
              ...
              <li>
                ...
                >
                  <span
                    class="text-gray-700 transition justify-center  group-hover:text-gray-700/75"
                  >
                    Live Chat
                  </span>
          ...
          <ul class="mt-8 space-y-4 text-sm">
            <li>
              ...
              >
                ...
                <span class="flex-1 text-gray-700">foodcuisine@doe.com</span>
              </a>
            </li>
