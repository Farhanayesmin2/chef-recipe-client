  ...
  return (
    <div>
      ...
      <p className="text-gray-500 text-center my-4">
        Explore More ,Our top six chef are showing most <br></br>delicious
        ...
        {data.map((chef) => (
          ...
          >
            <a href="#" class="group relative block overflow-hidden">
              <button class="absolute hover:bg-red-800 end-4 top-4 z-10 rounded-full bg-white p-1.5 text-gray-900 transition hover:text-gray-900/75">
              ...
              <div class="relative border border-gray-100 bg-white p-6">
                <span class="whitespace-nowrap rounded-full animate-pulse bg-red-600 px-3 py-1.5 text-xs font-medium">
                  Top
                </span>

                <h3 class="mt-4 text-xl font-bold text-rose-950">
                  {chef.chefName}
                </h3>
